...
## <div id='2'/>1.1.  목적
본 문서(설치가이드)는 파스타(5.0) 환경기준으로 PaaS-TA 모니터링을 설치하는데 있다.

## <div id='3'/>1.2.  범위
본 문서(설치가이드)는 파스타(5.0) 환경기준으로 PaaS-TA 모니터링을 설치하는데 있다. 모니터링중 IaaS-PaaS 통합 모니터링은 별도 통합 모니터링문서를 제공하며 본문서는 PaaS, CaaS, SaaS 모니터링 설치 가이드를 제공함에 있다.
